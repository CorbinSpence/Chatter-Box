...
userData[0].friends.push(user[1])
userData[0].friends.push(user[2])

userData[1].friends.push(user[0])
userData[1].friends.push(user[2])

userData[2].friends.push(user[0])
userData[2].friends.push(user[1])
